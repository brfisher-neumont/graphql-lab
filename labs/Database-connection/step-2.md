...
1. Sign up for a free-tier account at [aws.amazon.com](aws.amazon.com), if you don't already have one.
2. In the **IAM** console, create a new user for this project (don't use your root account credentials in the app). E.g. 'graphql-lab'.
...
3. Pick an AWS **region** to use consistently for this lab (e.g. `us-west-2`) — DynamoDB tables are region-scoped.
4. Open the **DynamoDB** console and confirm you can see the (currently empty) tables list for your chosen region.
